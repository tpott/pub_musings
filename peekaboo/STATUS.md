...
Production-ready voice-controlled web app for children. 271 tasks completed.
...
- Task 310 (2026-02-10): Deep inspection round 15 — add rate limiting to POST /api/auth/logout (10/min) and POST /api/log (30/min), update API.md
