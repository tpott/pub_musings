...
// VerificationHTML returns the HTML body for email verification emails.
func VerificationHTML(verifyURL string) string {
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="text-align: center; margin-bottom: 30px;">
        <h1 style="color: #1a1a1a; margin: 0;">Peekaboo</h1>
    </div>

    <div style="background: #f9f9f9; border-radius: 8px; padding: 30px;">
        <h2 style="margin-top: 0;">Verify Your Email</h2>
        <p>Thanks for signing up for Peekaboo! Please verify your email address by clicking the button below:</p>
        ...
        <p style="color: #666; font-size: 14px;">This link will expire in 24 hours. If you didn't create an account with Peekaboo, you can safely ignore this email.</p>
    ...
    <div style="text-align: center; margin-top: 30px; color: #999; font-size: 12px;">
        <p>Peekaboo - Voice-controlled media for kids</p>
    </div>
</body>
</html>`, verifyURL, verifyURL)
}

// VerificationText returns the plain text body for email verification emails.
func VerificationText(verifyURL string) string {
	return fmt.Sprintf(`Verify Your Email

Thanks for signing up for Peekaboo! Please verify your email address by clicking the link below:

%s

This link will expire in 24 hours.

If you didn't create an account with Peekaboo, you can safely ignore this email.

---
Peekaboo - Voice-controlled media for kids
`, verifyURL)
}
...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Sign In to Peekaboo</title>
</head>
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="text-align: center; margin-bottom: 30px;">
        <h1 style="color: #1a1a1a; margin: 0;">Peekaboo</h1>
    ...
    <div style="background: #f9f9f9; border-radius: 8px; padding: 30px;">
        <h2 style="margin-top: 0;">Sign In to Peekaboo</h2>
...
func MagicLinkText(loginURL string) string {
	return fmt.Sprintf(`Sign In to Peekaboo
