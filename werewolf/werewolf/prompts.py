...
def create_day_voting_prompt(player: Player, state: GameState) -> str:
    ...
    prompt += "Who do you vote to eliminate? Please respond with just the name of a player."
...
def create_narrator_day_start_message(state: GameState, eliminated_player: Optional[Player] = None) -> str:
...
def create_narrator_day_end_message(state: GameState, eliminated_player: Optional[Player] = None) -> str:
