...
| `vitest` | ^3.2.0 | Unit testing framework. Fast, Vite-native, supports mocking, fake timers, and TypeScript out of the box. 832 tests across 29 files. | Jest (slower startup, needs extra TS config), Mocha (more boilerplate, no built-in mocking) |
