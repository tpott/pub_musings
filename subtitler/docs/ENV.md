...
| Default | `30/min` |
| Required | No |
| Example | `LOG_RATE_LIMIT=60/min` |

Rate limit for the frontend log forwarding endpoint (`POST /api/log`). Prevents log spam and DoS attacks via unlimited log submissions.
