...
def seasonalize(n: int, arr: np.array) -> np.array:
  """seasonalize treats `arr` as a row indexed array. Each row
...
def main() -> None:
  ...
  parser.add_argument("n", type=int, help="The number of frequencies to seasonalize")
  ...
  print(series)
  print(seasonalize(args.n, series))
  print()
  ...
  print("big result")
  norm_arr = seasonalize(args.n, big_df.transpose().values)
