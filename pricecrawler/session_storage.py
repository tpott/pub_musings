...
def create_payment_session(user_id: str, conversation_id: str, name: Optional[str] = None) -> str:
    """
...
def update_user_status(user_id: str, session_id: str, conversation_id: str, name: Optional[str] = None) -> None:
    """
